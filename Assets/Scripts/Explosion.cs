...
public class Explosion : MonoBehaviour {
	...
	public void OnTriggerEnter2D(Collider2D other){
		if (other.tag == "Character" && other.gameObject.GetInstanceID() != owner.gameObject.GetInstanceID() && justHit.GetInstanceID() != other.gameObject.GetInstanceID() && !other.GetComponent<ZodiacCharacter> ().isInvincible  && !other.GetComponent<ZodiacCharacter> ().isStunned) {
